...
# 1/28/2023 - Jonathan Decker (Lokno)
#
# Modified path to dll (See _load_library)
#
# Original Source File:
# https://github.com/hasegaw/IkaLog3/blob/52c5c16923b38ad523e05ac1d92fbcfd964fed6a/ikalog/inputs/win/videoinput_wrapper.py

import ctypes
from ctypes import c_char_p, c_double, c_int, c_bool
import numpy as np
import os
import time
import threading
...
class VideoInputWrapper(object):
    ...
    def set_verbose(self, enable):
        self.dll.VI_SetVerbose(enable)

    def _load_library(self):
        videoinput_dll = os.path.join('win', 'videoinput.dll')
        ...
        self.dll.VI_SetVerbose.argtypes = [c_bool]
        self.dll.VI_SetVerbose.restype = None
